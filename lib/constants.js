...
// JetBrains Mono Nerd Font with Pretendard's Hangul merged in at two cells per
// syllable: https://github.com/kuskhan/jetendard
export const FONT_FAMILY = 'Jetendard'
...
// The highlight swatch sits behind the editor's own text, so each theme needs its own
// default: the same hue (~52°) at the lightness that theme can actually read against.
export const DEFAULT_HIGHLIGHT_COLORS = { dark: '#4B4310', light: '#F9EFA9' }
...
export const LANGUAGES = [
  ...
  { name: 'Git Attributes', mode: 'gitattributes', short: 'gitattributes' },
  { name: 'Git Ignore', mode: 'gitignore', short: 'gitignore' },
  {
    name: 'HTML/XML',
    mode: 'htmlmixed',
    mime: 'text/html',
